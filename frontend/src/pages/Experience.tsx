                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:border-purple-400/50">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            <div className="bg-gradient-to-r from-purple-500/10 to-purple-600/5 border border-purple-500/20 p-4 rounded-lg hover:border-purple-400/40 transition-colors">
                            ...
                            <div className="bg-gradient-to-r from-cyan-500/10 to-cyan-600/5 border border-cyan-500/20 p-4 rounded-lg hover:border-cyan-400/40 transition-colors">
                                <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 p-4 rounded-lg hover:border-emerald-400/40 transition-colors">
                                <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/5 border border-blue-500/20 p-4 rounded-lg hover:border-blue-400/40 transition-colors">
                                <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="border-t border-gray-700/50 pt-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="text-sm bg-yellow-500/20 text-yellow-300 px-3 py-2 rounded-lg border border-yellow-500/30 hover:bg-yellow-500/30 transition-colors">
                                    JavaScript
                                </span>
                                <span className="text-sm bg-purple-500/20 text-purple-300 px-3 py-2 rounded-lg border border-purple-500/30 hover:bg-purple-500/30 transition-colors">
                                    PHP
                                </span>
                                <span className="text-sm bg-green-500/20 text-green-300 px-3 py-2 rounded-lg border border-green-500/30 hover:bg-green-500/30 transition-colors">
                                    PostgreSQL
                                </span>
                                <span className="text-sm bg-blue-500/20 text-blue-300 px-3 py-2 rounded-lg border border-blue-500/30 hover:bg-blue-500/30 transition-colors">
                                    PL/pgSQL
                                </span>
                                <span className="text-sm bg-orange-500/20 text-orange-300 px-3 py-2 rounded-lg border border-orange-500/30 hover:bg-orange-500/30 transition-colors">
                                    iReport
                                </span>
                                <span className="text-sm bg-gray-500/20 text-gray-300 px-3 py-2 rounded-lg border border-gray-500/30 hover:bg-gray-500/30 transition-colors">
                                    Liderazgo
                                </span>
                            </div>
                        </div>
