    ...
    return (
        <section id={id}>
            <h2 className="mt-10 mb-8 text-2xl font-semibold flex items-center gap-3">
                <span className="text-lg text-purple-500 font-bold">02. </span>
                Experiencia
                <span className="bg-linear-to-r from-purple-500/50 to-transparent h-px flex-1"></span>
            </h2>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:border-purple-400/50">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                            <div className="mb-4 lg:mb-0">
                                ...
                                <p className="text-sm text-gray-400">2021 - 2026</p>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-8">
                            <div className="bg-linear-to-r from-purple-500/10 to-purple-600/5 border border-purple-500/20 p-4 rounded-lg hover:border-purple-400/40 transition-colors hover:-translate-y-1">
                            ...
                            <div className="bg-linear-to-r from-cyan-500/10 to-cyan-600/5 border border-cyan-500/20 p-4 rounded-lg hover:border-cyan-400/40 transition-colors hover:-translate-y-1">
                                <div className="flex items-center gap-3 mb-3">
