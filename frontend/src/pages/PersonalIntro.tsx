...
export const PersonalIntro = () => {
    ...
    return (
        <div className='p-4'>
            ...
            <p className='mt-2 mb-4 text-gray-200 text-base md:text-lg leading-relaxed hover:text-white transition-colors duration-300'>
                Desarrollo aplicaciones web modernas, accesibles y escalables con React/Next.js y TypeScript, combinando una sólida experiencia frontend con base backend en PHP y PostgreSQL.
            </p>
